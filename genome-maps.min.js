...
GenomeMaps.prototype.getFeatureSearchMenu=function(){var a=this;return Ext.create("Ext.menu.Menu",{margin:"0 0 10 0",floating:!0,items:[{text:"Genes",handler:function(){var b=new InputListWidget({title:"Gene List",viewer:a.genomeViewer});b.onOk.addEventListener(function(b,d){a.genomeViewer.openGeneListWidget(d)});b.draw()}},{text:"Transcript",handler:function(){var b=new InputListWidget({title:"Ensembl Transcript",viewer:a.genomeViewer});b.onOk.addEventListener(function(b,d){a.genomeViewer.openTranscriptListWidget(d)});
b.draw()}},{text:"Exon",handler:function(){var b=new InputListWidget({title:"Ensembl Exon List",viewer:a.genomeViewer});b.onOk.addEventListener(function(b,d){a.genomeViewer.openExonListWidget(d)});b.draw()}},{text:"SNP",handler:function(){var b=new InputListWidget({title:"SNP List",viewer:a.genomeViewer});b.onOk.addEventListener(function(b,d){a.genomeViewer.openSNPListWidget(d)});b.draw()}},{text:"Protein",handler:function(){var b=new InputListWidget({title:"Ensembl Protein",viewer:a.genomeViewer});
b.onOk.addEventListener(function(b,d){a.genomeViewer.openGOListWidget(d)});b.draw()}}]})};
GenomeMaps.prototype.getFunctionalSearchMenu=function(){var a=this;return Ext.create("Ext.menu.Menu",{margin:"0 0 10 0",floating:!0,items:[{text:"GO",handler:function(){var b=new InputListWidget({title:"Gene Ontology",viewer:a.genomeViewer});b.onOk.addEventListener(function(b,d){a.genomeViewer.openGOListWidget(d)});b.draw()}},{text:"Reactome",disabled:!0,handler:function(){alert("Not yet implemented")}},{text:"Interpro",handler:function(){var b=new InputListWidget({title:"Protein",viewer:a.genomeViewer});
